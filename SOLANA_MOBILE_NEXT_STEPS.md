...
**Requirements:**
- Size: Exactly 1200×600 pixels
- Format: PNG
- Content: Your app name + tagline with purple gradient background
- Example text: "Get Your SOL Back! | Reclaim SOL from Empty Token Accounts"

**Where to save:** `public/banner-1200x600.png`
