...
- **Crates & Levels System**: Mini-game where users earn levels from their points and open tiered crates to win SOL (one open per crate ever). Exponential milestone-based level formula — points needed per crate tier: Lv11=6,340 / Lv21=43,940 / Lv31=278,940 / Lv41=1,730,360 / Lv51=10,999,940 / Lv61=21,999,940 / Lv71=43,999,940 / Lv81=89,999,940 / Lv91=179,999,940. 10 crate tiers (Genesis→Apex) unlock every 10 levels. SOL rewards are sent from RELAYER_PRIVATE_KEY wallet. Discrete probability tiers per crate. Routes: `GET /api/crates/status/:wallet`, `POST /api/crates/open`, `GET /api/crates/history/:wallet`. Data in `crate_opens` table.
