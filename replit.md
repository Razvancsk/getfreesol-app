...
- **MarginFi Lending Integration**: Earn tab displays MarginFi lending markets (SOL, USDC, USDT, jitoSOL, mSOL, JUP, BONK) with deposit/withdraw functionality. Uses MarginFi SDK with fallback data when rate limits occur.
