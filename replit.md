...
- **Jupiter Swap Referral Fees**: Integrated 0.2% platform fee (platformFeeBps=20) on all swaps using simplified January 2025 API (no Referral Program setup required)
- **Referral Fee Account**: AT2ZEMu93yJdJfhATLMWYnGigFkJyZchcJWt1TCjPq5d receives 0.2% of swap output tokens automatically
