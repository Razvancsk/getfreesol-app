...
export class ObjectStorageService {
  ...
  // Upload resized NFT image to public storage
  async uploadResizedImage(imageBuffer: Buffer, originalImageUrl: string, nftMint: string): Promise<string> {
    try {
      ...
      const fileName = `resized-nft-${nftMint}-${timestamp}.jpg`;
