    ...
    try {
      ...
      if (feeReceiverAddress) {
        try {
          ...
          console.warn('DB unavailable for PDA validation, skipping developer fee address');
        }
        ...
        try {
          ...
          console.warn('DB unavailable for referral code lookup');
        }
      } else if (referralCode) {
        try {
          ...
          if (tempReferralData) {
            try {
              ...
              try {
                ...
                console.warn('DB unavailable for referral fallback');
              }
            }
          }
        } catch (dbErr) {
          console.warn('DB unavailable for referral code lookup, continuing without referral');
        }
      }
