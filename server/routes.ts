...
export async function registerRoutes(app: Express): Promise<Server> {
    ...
    try {
      ...
      if (addRentFee === 'true' && orderData.transaction && taker) {
        try {
          ...
          const PLATFORM_WALLET = new SolanaPublicKey('6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy');
          const RENT_FEE_LAMPORTS = 407856; // 20% of ~0.00203928 SOL rent
  ...
  app.post("/api/buffer-accounts/prepare-close", async (req, res) => {
    try {
      ...
      // Platform wallet
      const platformWalletAddress = '6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy';
  ...
  app.post("/api/sol-refund/prepare-transaction", async (req, res) => {
    try {
      ...
      if (platformFeeLamports > 0) {
        const feeCollectorPublicKey = new PublicKey('6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy');
  ...
  app.post("/api/sol-refund/record-success", async (req, res) => {
    try {
      ...
      const PLATFORM_WALLET_POINTS = '6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy';
  ...
  app.post("/api/tokens/record-burn-success", async (req, res) => {
    try {
      ...
      const PLATFORM_WALLET_POINTS_TOKEN = '6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy';
  ...
  app.post("/api/nfts/burn", async (req, res) => {
    try {
      ...
      // Add platform fee transfer
      const platformWallet = new PublicKey('6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy');
    ...
    try {
      ...
      if (success && signature) {
        ...
        try {
          ...
          const PLATFORM_WALLET_POINTS_NFT = '6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy';
  ...
  app.get("/api/user/stats/:walletAddress", async (req, res) => {
    try {
      ...
      const PLATFORM_WALLET_STATS = '6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy';
...
Claimer: ${walletAddress}`;
  ...
  app.post("/api/referral/claim", async (req, res) => {
    try {
      ...
      const platformPubkey = new PublicKey('6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy');
    ...
    try {
      ...
      if (platformFee > 0n) {
        transaction.add(
          SystemProgram.transfer({
            fromPubkey: new PublicKey(task.creatorWallet),
            toPubkey: new PublicKey('6ZCV6FWis2qxeBWEenCZhf1Ccsxokk9pKzak25zhaHvy'),
