  ...
  if (!publicKey) {
    return (
      <div className="min-h-screen theme-bg flex items-center justify-center p-4">
        <Card className="bg-slate-800/50 dark:bg-slate-800/50 bg-white/90 border-purple-500/30 max-w-md w-full">
    ...
    <div className="min-h-screen theme-bg">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="flex items-center justify-between mb-8">
          <Link href="/">
            <Button variant="ghost" className="text-purple-600 dark:text-purple-300 hover:text-purple-800 dark:hover:text-white hover:bg-purple-100 dark:hover:bg-purple-800/30">
              <ArrowLeft className="mr-2 h-4 w-4" />
              Back
            </Button>
          </Link>
          <div className="flex items-center gap-3">
            ...
            <span className="text-slate-800 dark:text-white font-bold text-lg">Get Free Sol</span>
          </div>
        </div>

        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white/90 dark:bg-slate-800/80 border border-purple-300 dark:border-purple-500/30 rounded-xl p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-600 dark:text-purple-300 text-sm">SOL Claimed</p>
                  <p className="text-2xl font-bold text-slate-800 dark:text-white" data-testid="text-sol-claimed">
            ...
            <div className="bg-white/90 dark:bg-slate-800/80 border border-purple-300 dark:border-purple-500/30 rounded-xl p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-600 dark:text-purple-300 text-sm">Accounts Closed</p>
                  <p className="text-2xl font-bold text-slate-800 dark:text-white" data-testid="text-accounts-closed">
            ...
            <div className="bg-white/90 dark:bg-slate-800/80 border border-purple-300 dark:border-purple-500/30 rounded-xl p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-600 dark:text-purple-300 text-sm">Tokens Burned</p>
                  <p className="text-2xl font-bold text-slate-800 dark:text-white" data-testid="text-tokens-burned">
            ...
            <div className="bg-white/90 dark:bg-slate-800/80 border border-purple-300 dark:border-purple-500/30 rounded-xl p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-600 dark:text-purple-300 text-sm">Total Points</p>
                  <p className="text-2xl font-bold text-slate-800 dark:text-white" data-testid="text-total-points">
