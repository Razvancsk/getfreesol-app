...
{activeTab === 'referrals' ? 'Earn 50% commission from your referrals — just by helping others!' : activeTab === 'burnTokens' ? (burnSubTab === 'tokens' ? 'Burn Unwanted Tokens.' : 'Burn Unwanted NFTs.') : activeTab === 'swap' ? 'Swap tokens instantly. Earn 50% of MEV rebates!' : activeTab === 'statistics' ? 'Track rent recovery metrics and top performers' : activeTab === 'points' ? 'Earn points for every account you close!' : activeTab === 'reclaim' && claimSubTab === 'programs' ? 'Recover SOL from failed program deploys.' : 'Get your SOL back!'}
            ...
            <div className="flex justify-center py-3 px-2">
              <div className="flex items-center space-x-3">
                <Button
                  ...
                  className={`min-w-[120px] px-6 py-3 text-base font-semibold rounded-full transition-all flex items-center justify-center gap-2 border ${
                    activeTab === 'reclaim' 
                ...
                >
                  <span className="text-base">🪙</span> Token
                </Button>
                <Button
                ...
                >
                  <span className="text-base">🖼️</span> NFT
                </Button>
          ...
          {activeTab === 'reclaim' && (
            <div className="space-y-4">
              {/* Sub-tabs for Empty Accounts vs Programs */}
              <div className="flex justify-center">
                <div className="inline-flex bg-purple-900/50 rounded-full p-1 border border-purple-500/30">
                  <button
                    onClick={() => setClaimSubTab('empty')}
                  ...
                  {bufferAccounts.length > 0 ? (
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="text-center p-4 bg-gradient-to-br from-purple-800/20 to-purple-900/30 backdrop-blur-sm border border-purple-500/20 rounded-xl">
                          <div className="text-2xl font-bold text-green-400">+{(bufferAccounts.reduce((sum, b) => sum + parseFloat(b.rentAmount), 0) * 0.85).toFixed(5)}</div>
                          <div className="text-xs text-purple-200">To Claim</div>
                        </div>
                      </div>
