              ...
              <div className={`rounded-2xl p-6 md:p-10 border ${isNightMode ? 'bg-[#141414] border-[#2a2a2a]' : 'bg-gradient-to-br from-blue-900/20 to-purple-900/30 border-blue-500/20'}`}>
                ...
                <div className="mb-6 max-w-2xl mx-auto">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <img src="/gsol-token-logo.png?v=4" alt="GSOL" className="w-14 h-14 rounded-full object-cover" />
                    <div>
                  ...
                  <div className={`rounded-2xl p-5 mb-5 space-y-4 ${isNightMode ? 'bg-[#1a1a1a] border border-[#2a2a2a]' : 'bg-purple-900/20 border border-purple-500/20'}`}>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white font-bold text-base flex items-center gap-2">
                        <img src="/gsol-token-logo.png?v=4" alt="GSOL" className="w-5 h-5 object-contain rounded-full" />
