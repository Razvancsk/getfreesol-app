      ...
      setTimeout(() => {
        if (result.won) {
          ...
          toast({
            ...
            style: { background: 'linear-gradient(135deg, #2d1b69, #1a1035)', color: '#e2d9f3', border: '2px solid #7c3aed', fontFamily: 'monospace', fontWeight: 'bold', padding: '10px 14px', minHeight: 'unset' },
          });
        }
