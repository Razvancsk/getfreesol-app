...
export default function GsolWelcomeModal() {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) handleClose(); }}>
      <DialogContent className="w-[88vw] max-w-sm p-0 overflow-hidden border-0 bg-transparent shadow-none [&>button]:hidden">

        {/* Purple site-style card */}
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#1a0533] via-[#2d0a5e] to-[#1a0533] border border-purple-500/30 shadow-2xl shadow-purple-900/50 px-6 py-6 text-center">
