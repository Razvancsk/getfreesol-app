...
export default function GsolWelcomeModal() {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[340px] rounded-2xl overflow-hidden bg-gradient-to-br from-[#1a0533] via-[#2d0a5e] to-[#1a0533] border border-purple-500/30 shadow-2xl shadow-purple-900/50 px-6 py-6 text-center">
        ...
        <div className="relative flex justify-center mb-3">
          <div className="absolute w-14 h-14 rounded-full bg-purple-500/40 blur-xl animate-pulse" />
          {!imgFailed ? (
            <img src={GSOL_IMAGES[imgIdx]} alt="GSOL" onError={handleImgError}
              className="relative w-14 h-14 rounded-full border-2 border-purple-400/50 shadow-lg" />
          ) : (
            <div className="relative w-14 h-14 rounded-full border-2 border-purple-400/50 bg-purple-700 flex items-center justify-center text-2xl font-black text-white">G</div>
          )}
        </div>

        {/* Title */}
        <h2 className="text-xl font-extrabold text-white leading-tight mb-2 relative">
          Get Free Sol Liquid<br />Staking Token is Live!
        </h2>

        {/* Subtitle */}
        <p className="text-purple-300 font-semibold text-sm mb-4 relative">
        ...
        <div className="space-y-2.5 mb-4 relative">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-white text-sm font-semibold text-left">Stay Liquid — use GSOL in DeFi while earning</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-base">🔒</span>
            <p className="text-white text-sm font-semibold text-left">100% Secure — your SOL stays on-chain</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-base">⚡</span>
            <p className="text-white text-sm font-semibold text-left">Unstake Anytime via Jupiter</p>
          </div>
        </div>

        {/* Tagline */}
        <p className="text-yellow-400 font-semibold text-sm mb-4 relative">
