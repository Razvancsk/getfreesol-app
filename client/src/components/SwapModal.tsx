    ...
    <>
      ...
      {showSearchModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-purple-900 w-full max-w-lg max-h-[80vh] flex flex-col rounded-2xl overflow-hidden">
            {/* Header */}
